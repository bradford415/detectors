...
from detectors.data.coco import build_coco_mini
...
def main(base_config_path: str):
    ...
    train_kwargs = {'batch_size': base_config['train']['batch_size'], 
                    'shuffle': True}
    val_kwargs = {'batch_size': base_config['validation']['batch_size'],
                  'shuffle': False}
    ...
    if use_cuda:
        ...
        cuda_kwargs = {'num_workers': base_config['cuda']['workers'],
                       'pin_memory': True} 
    ...
    dataset_train = dataset_map[base_config["dataset_name"]](split="train", **dataset_kwargs)
    dataset_val = dataset_map[base_config["dataset_name"]](split="val", **dataset_kwargs)
