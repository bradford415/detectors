...
def evaluate(
    ...
    image_detections = [] # list of image file paths and tensors containing nms dectections
    for steps, (samples, targets) in enumerate(tqdm(dataloader_test, desc="Evaluating")):
        ...
        nms_preds = non_max_suppression(
            predictions, conf_thres=0.1, iou_thres=0.5
        )
