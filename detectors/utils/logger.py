...
class SmoothedValue:
    ...
    def __init__(self, window_size=20, fmt=None):
        """Initalizes the SmoothedValue Meter

        Args:
            window_size: size of the queue for the deque; how many values to keep
                         track of before popping the queue
        """
        if fmt is None:
    ...
    def synchronize_between_processes(self):
        """Sums the total count and value across all processes
...
class MetricLogger:
    ...
    def synchronize_between_processes(self):
        """Syncyhronize the total count and value across all processes for every meter"""
