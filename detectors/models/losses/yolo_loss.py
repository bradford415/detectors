...
class YoloV4Loss(nn.Module):
    ...
    def build_target(self, pred: list[torch.Tensor], labels: list[dict], batch_size, f_map_size, num_pred_ch, output_id):
        ...
        ### MIGHT NEED TO CONVERT LABELS to x,y,w,h but not sure yet
        #### NEED TO FIGURE OUT WHERE IN THE GITHUB THAT CONVERSION HAPPENS, PROBABLY IN GETITEM BUT MAYBE LOSS FUCNTION
