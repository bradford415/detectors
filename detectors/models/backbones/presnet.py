...
class PResNet(nn.Module):
    ...
    ResNet-C: changes the first conv layer from 7x7 kernel with stride 2 to three 3x3 conv layers
    ResNet-D: changes the downsampling in the residual blocks to use avgpool + conv instead of just conv
    """
