...
from detectors.utils.box_ops import box_cxcywh_to_xyxy, box_xyxy_to_cxcywh
...
def get_contrastive_denoising_training_group(
    ...
    """Creates the contrastive denoising groups for RT-DETRv2

    This is very similar to setup_contrastive_denoising() in dino-detr however there
    are some small differences and the inputs/outputs are slightly different
    (tensors and shapes).
    """
    if num_denoising <= 0:
